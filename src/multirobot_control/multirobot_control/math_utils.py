...
def check_line_of_sight(line_start: Tuple[float,float], line_end: Tuple[float,float], 
    ...
    for (x0, y0, x1, y1) in obstacles:
        ...
        c1 = np.array((x0-inflate_dist/8*3, y0_))
        c2 = np.array((x0_, y0-inflate_dist/8*3))
        c3 = np.array((x0_, y1+inflate_dist/8*3))
        c4 = np.array((x0-inflate_dist/8*3, y1_))
        c5 = np.array((x1+inflate_dist/8*3, y1_))
        c6 = np.array((x1_, y1+inflate_dist/8*3))
        c7 = np.array((x1_, y0-inflate_dist/8*3))
        c8 = np.array((x1+inflate_dist/8*3, y0_))
